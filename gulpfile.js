...
gulp.task('scripts', function() {
  ...
  function buildTemplates() {
    return gulp.src('src/**/*.html')
      ...
      .pipe(templateCache({module: 'untemps.ut-angular-formWatcher'}));
  };

  function buildDistJS(){
    return gulp.src('src/ut-angular-formWatcher.js')
      .pipe(plumber({
  ...
  es.merge(buildDistJS(), buildTemplates())
    ...
    .pipe(order([
      'ut-angular-formWatcher.js',
      'template.js'
    ]))
    .pipe(concat('ut-angular-formWatcher.js'))
...
gulp.task('styles', function() {
  ...
  return gulp.src('src/ut-angular-formWatcher.less')
    .pipe(less())
    .pipe(header(config.banner, {
      timestamp: (new Date()).toISOString(), pkg: config.pkg
    }))
